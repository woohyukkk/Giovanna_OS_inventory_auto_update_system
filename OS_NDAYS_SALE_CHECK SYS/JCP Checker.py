...
OSM_list_link='Z:/Zoe/ATS/JCP_checkList.csv'
...
def outputReport():
    fo= open(str(today)+'_JCP_Sale_Report_in_'+str(TstDays)+'days.csv',"w",newline='')
    #fo= open('out.csv',"w",newline='')
    fieldnames=['Style','Sale in '+str(TstDays)+' days','Total Sale','Sale Months','Sale/Month','First on site','Last sale']
