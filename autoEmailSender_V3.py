#V3 auto pick customer actions and expert reports version
import csv
import smtplib
...
for item in look:
    ...
    if customerName=='OVE841' or customerName=='JCP750':    ########Skip jcp OS
       print ('JCP/OS Inv Skipped.')
       continue
    if customerCode in emails:########### check M F
...
for inv,info in reports.items():
    ...
    print ("Report: ",inv,info[0],info[1],info[2],info[3])
